...
class DistQ(object):
  """A simple implementation of tabular Distributed Q-learning."""
  ...
  def plot_qs(self, save_path=''):
    ...
    plt.grid()
    #plt.show()
    fig.savefig(fname=save_path+'dist_0', bbox_inches='tight')
    ...
    plt.grid()
    #plt.show()
    fig2.savefig(fname=save_path+'dist_1', bbox_inches='tight')
    ...
    plt.grid()
    #plt.show()
    fig3.savefig(fname=save_path+'dist_2', bbox_inches='tight')
    ...
    plt.grid()
    #plt.show()
    fig4.savefig(fname=save_path+'dist_3', bbox_inches='tight')
